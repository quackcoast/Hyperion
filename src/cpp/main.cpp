...
void uci_loop() {
    ...
    std::string model_path = "C:\\Users\\white\\Hyperion\\Hyperion\\data\\completed_models\\hyperion_16b_196f.pt";
    hyperion::engine::NeuralNetwork my_nn(model_path);
    ...
    engine::Search search_handler(&my_nn);
